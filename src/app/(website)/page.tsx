          ...
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-lg bg-transparent border-4 border-indigo-500 flex items-center justify-center font-bold">
                Ɨ⨍
                </div>
              ...
              <Button className="text-primary text-black">
