...
const AutomationList = (props: Props) => {
  ...
  // Optimistic UI: Combine new data with existing data
  const optimisticUiData = useMemo(() => {
    if (latestVariable?.variables && data?.data) {
      return { data: [latestVariable.variables, ...data.data] };
    }
    return data || { data: [] };
  }, [latestVariable, data]);

  // Handle empty or unsuccessful data state
        ...
        >
          ...
          <div className="flex flex-col justify-between">
            <p className="capitalize text-sm font-light text-[#9B9CA0]">
              ...
              {getDateSuffix(automation.createdAt.getUTCDate())}{' '}
